...
### Leverages building Docker image using Docker in Docker
This template expands upon the existing Secure-kube-toolchain template by building the Docker image using Docker in Docker.
...
- ensure Docker unit tests, sanity checks and successful build
